...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 71.0, 484.0, 73.0, 22.0 ],
					"text" : "r #0-color"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 71.0, 518.0, 85.0, 22.0 ],
					"text" : "color $1 $2 $3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 166.0, 107.0, 75.0, 22.0 ],
					"text" : "s #0-color"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 13.0, 69.0, 216.0, 22.0 ],
					"text" : "route flock-metro parameter color reset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 65.0, 377.0, 81.0, 22.0 ],
					"text" : "r #0-param"
				}
...
,
					"patching_rect" : [ 50.0, 270.0, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 50.0, 570.0, 491.0, 22.0 ],
					"text" : "jit.gl.mesh flock-world @draw_mode points @point_size 2 @color 1. 1. 1. 1 @scale 5. 5. 5."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 265.0, 449.0, 190.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 50.0, 449.0, 191.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 962.0, 374.0, 71.0, 22.0 ],
									"text" : "param D3 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 962.0, 338.0, 133.0, 22.0 ],
...
,
					"patching_rect" : [ 50.0, 415.0, 239.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 270.0, 339.0, 190.0, 22.0 ],
					"text" : "jit.matrix #1-velocity 3 float32 16 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 50.0, 339.0, 191.0, 22.0 ],
					"text" : "jit.matrix #1-position 3 float32 16 1"
				}
