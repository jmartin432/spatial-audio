...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 134.0, 76.0, 88.0, 23.0 ],
					"text" : "autowatch $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 97.0, 111.0, 107.0, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "granularSynth.js",
						"parameter_enable" : 0
					}
,
					"text" : "js granularSynth.js"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 311.0, 523.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 311.0, 560.0, 59.0, 22.0 ],
					"text" : "mute 1, 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 281.0, 359.0, 59.0, 22.0 ],
					"text" : "mute 0, 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 280.0, 592.0, 56.0, 22.0 ],
					"text" : "thispoly~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 134.0, 329.0, 87.0, 22.0 ],
					"text" : "wave~ window"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 92.0, 428.0, 42.0, 22.0 ],
					"text" : "out~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 92.0, 384.0, 30.0, 22.0 ],
					"text" : "*~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 54.0, 324.0, 66.0, 22.0 ],
					"text" : "play~ clip1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 54.0, 287.0, 34.0, 22.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 134.0, 287.0, 34.0, 22.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 134.0, 248.0, 45.0, 22.0 ],
					"text" : "0, 1 $3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.0, 248.0, 65.0, 22.0 ],
					"text" : "$1 0 $2 $3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 97.0, 181.0, 52.0, 22.0 ],
					"text" : "pack i i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 92.0, 10.0, 28.0, 22.0 ],
					"text" : "in 1"
				}
